...
interface GroupType {
	name: string,
	type: "SameCardSameRoomMultiBuy" | "SameCardMultiRoomBuy" | "UserBuysFromSingleTable" | "CardCanBeBoughtFromSingleTable",}
const simdilikGroupTypes: GroupType[] = [
	...
	{ name: '1 kere al her yerde kilitle', type: "CardCanBeBoughtFromSingleTable" }
];
