...
Handlebars.registerHelper("translate", function(data) {
  switch (data) {
...
class TableGroupsAndTables extends Request {
  ...
  tableGroupsAndTablesTemplate = fetch(
    require("../partials/tableGroupsAndTables.hbs")
  )
    .then(d => d.text())
    .then(Handlebars.compile.bind(this));
  addTableTemplate = fetch(require("../partials/addTable.hbs"))
    .then(d => d.text())
    .then(Handlebars.compile.bind(this));
  editTableGroupTemplate = fetch(require("../partials/editTableGroup.hbs"))
    .then(d => d.text())
    .then(Handlebars.compile.bind(this));
  delTableGroupTemplate = fetch(require("../partials/deleteTableGroup.hbs"))
    .then(d => d.text())
    .then(Handlebars.compile.bind(this));
  editTableTemplate = fetch(require("../partials/editTable.hbs"))
    .then(d => d.text())
    .then(Handlebars.compile.bind(this));
  delTableTemplate = fetch(require("../partials/deleteTable.hbs"))
    .then(d => d.text())
    .then(Handlebars.compile.bind(this));
  modal: any;
